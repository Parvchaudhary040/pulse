...
export default function LandingPage({ onEnterApp, onGoToLogin, onGoToSignup }: LandingPageProps) {
  return (
    <div className="bg-[#0b0c10] text-[#f4f6fe] min-h-screen font-sans selection:bg-[#4f46e5] selection:text-white overflow-x-hidden">
      ...
      {/* Header */}
      <header className="border-b border-gray-800/60 backdrop-blur-md sticky top-0 z-50 bg-[#0b0c10]/80">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm text-gray-400 font-medium">
            ...
            <a href="#faq" className="hover:text-white transition-colors duration-200">Docs</a>
          </nav>

          <div className="flex items-center gap-4">
            <button 
              onClick={onGoToLogin} 
              className="px-4 py-2 text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-800/40 rounded-lg transition-all"
            >
              Sign In
            </button>
            <button 
              onClick={onGoToSignup} 
              className="px-4 py-2 text-sm font-medium bg-[#1a1b24] hover:bg-[#20222f] border border-gray-700/80 rounded-lg text-white transition-all duration-200 shadow-sm"
            >
              Register
            </button>
            <button 
              onClick={onEnterApp} 
              className="bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold px-4 py-2 rounded-lg transition-all duration-200 flex items-center gap-2 shadow-lg shadow-indigo-600/35 hover:scale-[1.02]"
            >
              Launch Sandbox
      ...
      <section className="relative pt-24 pb-16 md:py-32 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <button 
              onClick={onEnterApp}
              className="w-full sm:w-auto bg-gradient-to-r from-indigo-600 to-indigo-505 bg-indigo-600 hover:from-indigo-550 hover:to-indigo-500 hover:shadow-indigo-500/30 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 shadow-xl flex items-center justify-center gap-3 text-base group"
            >
            ...
            <a 
              href="#features"
              className="w-full sm:w-auto px-8 py-4 rounded-xl border border-gray-800 bg-gray-900/30 text-gray-300 hover:text-white hover:bg-gray-800/45 transition-all text-base font-semibold text-center"
            >
              Learn More
            </a>
          </motion.div>
      ...
      <section className="py-8 border-y border-gray-900 bg-[#08090d]/60 mb-16">
      ...
      <section id="features" className="py-20 max-w-7xl mx-auto px-6 relative">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="p-8 rounded-2xl bg-[#12131a]/95 border border-gray-800/80 hover:border-indigo-500/40 transition-all duration-300 shadow-xl group">
            ...
            <h4 className="text-xl font-bold text-white mb-2">Omnipresent Board Tracker</h4>
          ...
          {/* Card 2 */}
          <div className="p-8 rounded-2xl bg-[#12131a]/95 border border-gray-800/80 hover:border-[#10b981]/40 transition-all duration-300 shadow-xl group">
            ...
            <h4 className="text-xl font-bold text-white mb-2">Live Activity Timelines</h4>
            <p className="text-gray-400 text-sm font-light leading-relaxed">
          ...
          {/* Card 3 */}
          <div className="p-8 rounded-2xl bg-[#12131a]/95 border border-gray-800/80 hover:border-purple-500/40 transition-all duration-300 shadow-xl group">
            ...
            <h4 className="text-xl font-bold text-white mb-2">Rich Analytics Visualizers</h4>
            <p className="text-gray-400 text-sm font-light leading-relaxed">
      ...
      <section id="workflow" className="py-16 bg-[#08090d]/80 border-y border-gray-900 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative p-2 rounded-2xl bg-gray-900/40 border border-gray-800/80 shadow-2xl backdrop-blur-sm overflow-hidden">
              <div className="h-6 flex items-center gap-1.5 px-4 border-b border-gray-800 bg-[#0f111a]">
              ...
              <div className="bg-[#0b0c10] p-6 space-y-4">
                ...
                <div className="space-y-2.5 pt-2">
                  ...
                  <div className="p-3 bg-gray-900/30 rounded-xl border border-gray-800/40 opacity-40 flex items-center justify-between">
      ...
      <section id="pricing" className="py-20 max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="p-8 rounded-2xl bg-[#0e0f14] border border-gray-800 flex flex-col justify-between">
            <div>
              <span className="text-xs font-mono text-gray-500 uppercase tracking-widest">INDIVIDUAL</span>
              <h4 className="text-2xl font-bold text-white mt-1 mb-4">Starter</h4>
            ...
            <button 
              onClick={onEnterApp}
              className="w-full py-3 rounded-lg border border-gray-800 bg-gray-900/30 hover:bg-gray-800 text-white font-medium text-sm transition-all"
            >
              Get Started Free
            </button>
          </div>
          ...
          {/* Card 2 - Featured */}
          <div className="p-8 rounded-2xl bg-[#12131a] border-2 border-indigo-600 flex flex-col justify-between relative shadow-2xl">
            <div className="absolute top-0 right-6 -translate-y-1/2 bg-indigo-600 text-white text-[10px] uppercase font-mono tracking-widest h-6 px-3 rounded-full flex items-center justify-center font-bold">
              MOST POPULAR
            </div>
            <div>
              <span className="text-xs font-mono text-indigo-400 uppercase tracking-widest">TEAM CLUSTER</span>
              <h4 className="text-2xl font-bold text-white mt-1 mb-4">Pulse Pro</h4>
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-extrabold text-white">$24</span>
                <span className="text-xs text-gray-400 font-mono">/ USER MONTHLY</span>
              </div>
              <p className="text-sm text-gray-400 font-light mb-8">
              ...
              <ul className="space-y-4 mb-8 text-sm text-gray-350">
                <li className="flex items-center gap-3">
                  <Check className="w-4 h-4 text-[#10b981]" />
                  <span className="text-white">Uncapped Web Projects</span>
                </li>
                <li className="flex items-center gap-3">
                  <Check className="w-4 h-4 text-[#10b981]" />
                  <span className="text-white">Detailed Activity Timelines</span>
                </li>
                <li className="flex items-center gap-3">
                  <Check className="w-4 h-4 text-[#10b981]" />
            ...
            <button 
              onClick={onEnterApp}
              className="w-full py-3 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-sm transition-all shadow-lg shadow-indigo-600/30 hover:scale-[1.01]"
            >
              Enter Pro Sandbox
            </button>
          </div>
          ...
          <div className="p-8 rounded-2xl bg-[#0e0f14] border border-gray-800 flex flex-col justify-between">
            <div>
              ...
              <h4 className="text-2xl font-bold text-white mt-1 mb-4">Custom Scale</h4>
              <div className="flex items-baseline gap-1 mb-6">
      ...
      {/* Docs FAQ Section */}
      <section id="faq" className="py-16 bg-[#08090d]/60 border-t border-gray-900 relative">
        <div className="max-w-4xl mx-auto px-6">
          <h3 className="text-3xl font-extrabold text-white text-center tracking-tight mb-12">Frequently Asked Questions</h3>
          <div className="space-y-6">
            <div className="p-6 bg-gray-900/30 rounded-xl border border-gray-800/80">
              <h4 className="text-base font-bold text-white mb-2">Can I manage tasks across desktop and mobile screens simultaneously?</h4>
            ...
            <div className="p-6 bg-gray-900/30 rounded-xl border border-gray-800/80">
              <h4 className="text-base font-bold text-white mb-2">What is the Pulse sandbox environment?</h4>
              <p className="text-sm text-gray-400 font-light">
            ...
            <div className="p-6 bg-gray-900/30 rounded-xl border border-gray-800/80">
              <h4 className="text-base font-bold text-white mb-2">Can I customize notification parameters?</h4>
              <p className="text-sm text-gray-400 font-light">
      ...
      {/* Footer */}
      <footer className="border-t border-gray-900 bg-[#06070a]/90 py-12 px-6 text-center text-sm text-gray-500">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          <PulseLogo size="sm" />
          <p className="font-light">© 2026 Pulse SaaS Platform. Recreated with ultimate care & precision.</p>
          <div className="flex gap-6">
            <a href="#features" className="hover:text-white transition-colors duration-200">System</a>
            <a href="#pricing" className="hover:text-white transition-colors duration-200">Rules</a>
            <a href="#workflow" className="hover:text-white transition-colors duration-200">GitHub</a>
          </div>
        </div>
      </footer>
    </div>
